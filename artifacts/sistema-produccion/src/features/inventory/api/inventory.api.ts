...
import type { AdjustmentInput, ClassifyLotInput, CreateWarehouseInput, IdempotentCommand, InventoryLot, LotClassificationResult, MovementInput, MovementResult, Stock, StockFilters, TransferInput, TransferResult, UpdateWarehouseInput, Warehouse, WarehouseListFilters } from '../types/inventory.types';
