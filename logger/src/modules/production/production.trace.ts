...
export interface ProductionBatchTraceDto {
  ...
  works: Array<{ id: string; productionOrderId: string; transformationOrderId: string | null; workTypeId: string; performedAt: string; observations: string | null; version: number; workType: { id: string; code: string; name: string }; batches: string[]; containers: string[]; participants: Array<{ participantId: string; role: string | null }>; inputs: Array<{ id: string; productionWorkId: string; articuloId: string; warehouseId: string | null; inventoryLotId: string | null; quantity: string; unit: string; inventoryMovementId: string | null; operationKey: string | null; requestHash: string | null; status: "ACTIVE"|"REVERSED"; reversedAt: string | null; reversalInventoryMovementId: string | null; reversalOperationKey: string | null; reversalRequestHash: string | null; reversalReason: string | null }>; corrections: CorrectionDto[] }>;
